...
---------------------------------------------------
 â•°â—ˆâ–ªâž£ Github    : https://github.com/Dilute Codes
 â•°â—ˆâ–ªâž£ Facebook  : 033[92;1m
 â•°â—ˆâ–ªâž£ Author    : fat condem ka nateeja = Dilute Codes( Ghasti maa ka Beta )
 â•°â—ˆâ–ªâž£ Version   : DC Extreme [2.2]
 â•°â—ˆâ–ªâž£   \033[1;96mNaam Ki Dosti Kaam ki Yaari\n\tDosron Ki Tarah ! Adat Nhi Hamari \033[1;97m
---------------------------------------------------''')
	p(logo)
...
class Main:
	...
	def menu(self):
		logo()
		p(' [â€¢] This Script is Free Open-Souce by Minahil  ')
		line()
		p(' [1] File Cracking ')
